...
<div id="repeater-colaborator">
    ...
    <div class="form-row mb-4 mt-4">
        <div class="col-2">
            ...
            <input type="text" name="beneficiary_height[]" value="{{ old('beneficiary_height.0', $beneficiaries[0]->height ?? null) }}" class="form-control height" placeholder="Altura">
        ...
        <div class="col-2">
            ...
            <input type="text" name="beneficiary_weight[]" value="{{ old('beneficiary_weight.0', $beneficiaries[0]->weight ?? null) }}" class="form-control weight" placeholder="Peso">
        ...
        <div class="col-2">
            <label for="">IMC</label>
            <input type="text" readonly name="beneficiary_imc[]" value="{{ old('beneficiary_imc.0', $beneficiaries[0]->imc ?? null) }}" class="form-control imc-calc">
        ...
        @foreach(old('beneficiary_cpf', $beneficiaries ?? null) as $k => $v)
            ...
            <fieldset class="form-group dependent"><span class="count">#{{ $k }}</span>
                ...
                <div class="form-row mb-4 mt-4">
                    <div class="col-2">
                        <label for="">Altura</label>
                        <input type="text" name="beneficiary_height[]" value="{{ old('beneficiary_height.' . $k, $beneficiaries[$k]->height ?? null) }}" class="form-control" placeholder="Altura" required>
                    ...
                    <div class="col-2">
                        <label for="">Peso</label>
                        <input type="text" name="beneficiary_weight[]" value="{{ old('beneficiary_weight.' . $k, $beneficiaries[$k]->weight ?? null) }}" class="form-control" placeholder="Peso" required>
                    ...
                    <div class="col-2">
                        <label for="">IMC</label>
                        <input type="text" readonly name="beneficiary_imc[]" value="{{ old('beneficiary_imc.' . $k, $beneficiaries[$k]->imc ?? null) }}" class="form-control imc-calc">
